...
class Constraints_generator():
    ...
    def genModel(self, filename):
        ...
        fid = open('./skinnye_v2/TR' + str(self.TR) + '_ini' + str(self.ini_r) + '_inik' + str(self.ini_k) + '_matr' + str(self.mat_r) + '_v1.lp', 'w')
...
def cmd():
    rd = open('./skinnye_v2/Result.txt', 'w')
            ...
            for ini_k in range(0, 1):
                for mat_r in range(0, TR):
                    if mat_r != ini_r:                        
                        ...
                        name = './skinnye_v2/TR' + str(TR) + '_ini' + str(ini_r) + '_inik' + str(ini_k) + '_matr' + str(mat_r)
