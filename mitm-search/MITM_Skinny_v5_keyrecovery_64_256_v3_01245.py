...
class Constraints_generator():
    ...
    def genModel(self, filename):
        ...
        fid = open('./skinny/TR' + str(self.TR) + '_ini' + str(self.ini_r) + '_matr' + str(self.mat_r) + 's1' + str(self.s1) + 's2' + str(self.s2)+ '_v1.lp', 'w')
...
def cmd():
    rd = open('./skinny/Result_4TK_31_v2.txt', 'w')
                ...
                for s1 in range(6, 7):
                    for s2 in range(23, 24):
                        if (ini_r < mat_r and ini_r<s1<mat_r-6 and mat_r<s2) or (ini_r > mat_r and ini_r<s1<TR-6 and s2<mat_r):                        
                            ...
                            name = './skinny/TR' + str(TR) + '_ini' + str(ini_r) + '_matr' + str(mat_r) + 's1' + str(s1) + 's2' + str(s2)
