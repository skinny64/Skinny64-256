...
int hN1=512*16;
__constant__ int N1=512*16;

__constant__ int r=5;
__constant__ unsigned char dk1[32] = {00,00, 00,00, 00,00, 00,0x05, 
                                      00,00, 00,00, 00,00, 00,0x07, 
                                      00,00, 00,00, 00,00, 00,0x04, 
                                      00,00, 00,00, 00,00, 00,0x0c};
__constant__ unsigned char dk2[32] = {00,00, 00,00, 00,0x40, 00,00, 
                                      00,00, 00,00, 00,0x40, 00,00, 
                                      00,00, 00,00, 00,0xf0, 00,00, 
                                      00,00, 00,00, 00,0x80, 00,00};
__constant__ unsigned char dp[8] = {00,00, 00,00, 0xa0,00, 00,00}; 
__constant__ unsigned char dc[8] = {00,00, 0x05,0x05, 00,0x50, 0x05,00};*/
